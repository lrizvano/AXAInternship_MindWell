...
function bot() { 
	...
	if (questionNum == 0) {
    		output.innerHTML = '<h1>My name is Edison and I help with ideation.</h1>'; // output response
			...
			output.innerHTML = '<h1>Check out this image to make sure.</h1>';
    			setTimeout(timedQuestion, 2000);
			window.open("http://images2.minutemediacdn.com/image/upload/c_fit,f_auto,fl_lossy,q_auto,w_728/v1555916687/shape/mentalfloss/cognitive_biases.png");
			document.getElementById("input").value = "";   
    			question = '<h1>Was that helpful?</h1>';					      	
    			setTimeout(timedQuestion, 2000);
		}
